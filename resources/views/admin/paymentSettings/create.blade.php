        ...
        <form method="POST" action="{{ route("admin.payment-settings.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('tax_enabled') ? 'is-invalid' : '' }}">
                    <input class="form-check-input" type="checkbox" name="tax_enabled" id="tax_enabled" value="1" required {{ old('tax_enabled', 0) == 1 || old('tax_enabled') === null ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tax_percentage') ? 'is-invalid' : '' }}" type="number" name="tax_percentage" id="tax_percentage" value="{{ old('tax_percentage', '') }}" step="0.01" required>
