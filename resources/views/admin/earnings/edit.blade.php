    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.earnings.update", [$earning->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('provider') ? 'is-invalid' : '' }}" name="provider_id" id="provider_id" required>
                    @foreach($providers as $id => $entry)
                        <option value="{{ $id }}" {{ (old('provider_id') ? old('provider_id') : $earning->provider->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bookings_count') ? 'is-invalid' : '' }}" type="number" name="bookings_count" id="bookings_count" value="{{ old('bookings_count', $earning->bookings_count) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_earning') ? 'is-invalid' : '' }}" type="number" name="total_earning" id="total_earning" value="{{ old('total_earning', $earning->total_earning) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('admin_earning') ? 'is-invalid' : '' }}" type="number" name="admin_earning" id="admin_earning" value="{{ old('admin_earning', $earning->admin_earning) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('provider_earning') ? 'is-invalid' : '' }}" type="number" name="provider_earning" id="provider_earning" value="{{ old('provider_earning', $earning->provider_earning) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_tax') ? 'is-invalid' : '' }}" type="number" name="total_tax" id="total_tax" value="{{ old('total_tax', $earning->total_tax) }}" step="0.01" required>
